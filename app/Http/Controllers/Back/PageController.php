...
class PageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('success-alert', 'Page created successful.');
    }
    ...
    public function update(Request $request, Page $page)
    {
        ...
        return redirect()->back()->with('success-alert', 'Page updated successful.');
    }
    ...
    public function destroy(Page $page)
    {
        ...
        return redirect()->route('back.pages.index')->with('success-alert', 'Page deleted successful.');
    }
