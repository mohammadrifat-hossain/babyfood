...
return [
    ...
    */
    ...
    |
    */
	'geo_region' => env('APP_ADDRESS', null), //e.g: Lagos
	'geo_position' => env('APP_GEO_POSITION', null), //e.g(lng,lat): 4.870467,6.993388
    ...
    */
    ...
    |
    */
	'keywords' => env('APP_KEYWORDS', null),
