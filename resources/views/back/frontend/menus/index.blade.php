...
@section('master')
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="card border-light mt-3 shadow">
                ...
                <div class="card-body">
                    <div class="accordion accordionFrontMenu" id="accordionFrontMenu">
                        ...
                        <div class="card">
                          <div class="card-header no_icon" id="headingFMBlogs">
                            <h2 class="mb-0">
            ...
            <div class="card border-light mt-3 shadow">
                <div class="card-header">
                    <h6 class="d-inline-block">How to Create Menu</h6>
                </div>

                <div class="card-body">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/47MD-zIUcQw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
