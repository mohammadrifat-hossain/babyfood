...
@section('master')
    <div class="card shadow text-dark mb-3">
        <div class="card-header">
            <h5 class="d-inline-block"><b>Landing Pages Edit</b></h5>

            <a href="{{route('back.landingBuilderB.index')}}" class="btn btn-sm btn-info float-right"><i class="fas fa-angle-left"></i> Back</a>
        </div>

        <form action="{{route('back.landingBuilderB.update', $landing->id)}}" method="POST">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="mobile_number" class="form-control" value="{{old('mobile_number', ($landing->others['mobile_number'] ?? ''))}}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            <select name="server_site_track" class="form-control">
                                <option value="No" @checked($landing->server_track == 'No')>No</option>
                                <option value="Yes" @checked($landing->server_track == 'Yes')>Yes</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editor" class="form-control" name="description" cols="30" rows="3">{{old('description', ($landing->others['description'] ?? ''))}}</textarea>
                        </div>

                        <div class="form-group">
                            <label><b>Video Embed Code</b></label>

                            <textarea class="form-control" name="vide_embed_code" cols="30" rows="3">{{old('vide_embed_code', ($landing->others['vide_embed_code'] ?? ''))}}</textarea>
                        </div>
                    </div>
                </div>
