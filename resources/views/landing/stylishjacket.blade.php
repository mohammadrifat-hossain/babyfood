...
<div class="container mt-4">
    <div class="text-xl md:text-4xl bg-yellow-300 text-center py-4 px-1 rounded mb-4 font-bold">
        ...
        <a href="#" class="mb-4 text-lg" data-scroll-nav="0">আমাদের জ্যাকেট খারাপ কিনা কাস্টমারের <button class="bg-green-800 px-2 py-1 rounded text-white text-base">রিভিউ দেখুন</button></a>
    </div>
    ...
    <div data-scroll-index="0">
            ...
            <div class="p-3">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="border p-2 responsive_video">
                        <iframe width="360" height="315" src='https://www.youtube.com/embed/OwFnL0lrnT8?controls=0&rel=0&playsinline=0&modestbranding=0&autoplay=0&enablejsapi=1' title='' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' class='lazy' allowfullscreen='1'></iframe>
                    ...
                    <div class="border p-2 responsive_video">
                        <iframe width="360" height="315" src='https://www.youtube.com/embed/ELz7YB2cjec?controls=0&rel=0&playsinline=0&modestbranding=0&autoplay=0&enablejsapi=1' title='' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' class='lazy' allowfullscreen='1'></iframe>
        ...
        <h3 class="text-2xl md:text-4xl text-center md:text-left text-gray-600 mt-5 mb-5">
            কেন আপনি একটি স্টাইলিশ জ্যাকেট কিনবেন?
        ...
        <p class="mb-3">নিজেকে স্টাইলিস্ট ও রুচি সম্পন্ন করে প্রকাশ করার জন্য স্টাইলিশ জ্যাকেট এর কোন বিকল্প নেই শীতকালে।  চলুন বন্ধুরা আমরা জেনে নেই কেন আমরা একটি স্টাইলিশ জ্যাকেট কিনবঃ
        </p>
        <ul class="md:px-5 mb-2">
            ...
            <li class="text-xl overflow-hidden mb-1"><img class="check_image inline-block mr-2 float-left" src="{{asset('landing/2705.svg')}}" alt="check"> <span class="float-left list_text">আপনি আপনার স্টাইল অনুযায়ী বিভিন্ন পোশাকের সাথে একটি স্টাইলিশ জ্যাকেট পরতে পারবেন।
            </span>
            </li>
            <li class="text-xl overflow-hidden mb-1"><img class="check_image inline-block mr-2 float-left" src="{{asset('landing/2705.svg')}}" alt="check"> <span class="float-left list_text">একটি স্টাইলিশ জ্যাকেট কখনোই ওল্ড ফ্যাশন হয়না আপনি এটি সবসময় ব্যবহার করতে পারবেন।</span>
            </li>
            <li class="text-xl overflow-hidden mb-1"><img class="check_image inline-block mr-2 float-left" src="{{asset('landing/2705.svg')}}" alt="check"> <span class="float-left list_text">সাধারণত মানুষ স্টাইলিশ জ্যাকেটকে প্রশংসা করে অন্য যেকোনো উল সোয়েটারে তুলনায়।</span>
            <li class="text-xl overflow-hidden mb-1"><img class="check_image inline-block mr-2 float-left" src="{{asset('landing/2705.svg')}}" alt="check"> <span class="float-left list_text">স্টাইলিশ জ্যাকেট এমন একটি জিনিস যদি আপনি আপনার প্রিয় মানুষকে অথবা আপনার আত্মীয়-স্বজন বন্ধু-বান্ধবদের এটি উপহার দেন তারা সবসময় আপনাকে মনে রাখবে।</span>
            <li class="text-xl overflow-hidden mb-1"><img class="check_image inline-block mr-2 float-left" src="{{asset('landing/2705.svg')}}" alt="check"> <span class="float-left list_text">আপনি যদি একজন বাইকার হন তাহলে একটি স্টাইলিশ জ্যাকেট আপনাকে শীত থেকে বাঁচাবে সাথে রাস্তার ধুলাবালি থেকে আপনাকে বাঁচিয়ে রাখবে।</span>
            <li class="text-xl overflow-hidden mb-1"><img class="check_image inline-block mr-2 float-left" src="{{asset('landing/2705.svg')}}" alt="check"> <span class="float-left list_text">একটি স্টাইলিশ জ্যাকেট পরিধানের মাধ্যমে আপনি নিজেকে একটি সম্ভ্রান্ত ব্যক্তি হিসেবে প্রকাশ করতে পারেন</span>
            <li class="text-xl overflow-hidden mb-1"><img class="check_image inline-block mr-2 float-left" src="{{asset('landing/2705.svg')}}" alt="check"> <span class="float-left list_text">আপনি পৃথিবীর যে কোন দেশে ভ্রমণ করেন না কেন আপনি সব সময় দেখবেন স্টাইলিশ জ্যাকেট সব দেশেই সবচেয়ে বেশি জনপ্রিয়।</span>
            </li>
        </ul>
    ...
    <div class="border-yellow-300 border-2 rounded mb-4">
        <h2 class="text-2xl md:text-4xl bg-yellow-300 text-center py-2 font-bold px-1"><a href="https://cutpricebd.com/bn/category/44/leather-jacket-winter-collections" class="text-green-800 underline">Cutpricebd.com</a> থেকে স্টাইলিশ জ্যাকেট কিনলেই পাচ্ছেন আকর্ষণীয় ডিসকাউন্ট অফার!!</h2>
        <div class="p-3">
    ...
    <div class="border-yellow-300 border-2 rounded">
        <h2 class="text-2xl md:text-4xl bg-yellow-300 text-center py-2 font-bold px-1">কেন <a href="https://cutpricebd.com/bn/category/44/leather-jacket-winter-collections" class="text-green-800 underline">Cutpricebd.com</a> থেকে স্টাইলিশ জ্যাকেট কিনবেনঃ</h2>
        <div class="p-3">
            <ul class="md:px-5 mb-2">
                <li class="text-xl overflow-hidden mb-1"><img class="check_image inline-block mr-2 float-left" src="{{asset('landing/2705.svg')}}" alt="check"> <span class="float-left list_text">বাংলাদেশের সবচেয়ে জনপ্রিয় স্টাইলিশ জ্যাকেট ব্রান্ডের প্রডাক্টগুলো আমাদের কাছে আপনারা পাবেন।</span></li>
                ...
                <li class="text-xl overflow-hidden mb-1"><img class="check_image inline-block mr-2 float-left" src="{{asset('landing/2705.svg')}}" alt="check"> <span class="float-left list_text">আমরা বাংলাদেশ প্রায় ১০ বছর যাবত অনলাইনে সফলতার সাথে স্টাইলিশ জ্যাকেট সরবরাহ করে আসছি।</span></li>
                ...
                <li class="text-xl overflow-hidden mb-1"><img class="check_image inline-block mr-2 float-left" src="{{asset('landing/2705.svg')}}" alt="check"> <span class="float-left list_text">সহজলভ্য মূল্যের আমাদের পোশাকের যেকোনো সমস্যা দেখতে পেলে কোন সন্দেহ ছাড়াই স্টাইলিশ জ্যাকেট কেনার বাংলাদেশের সবচেয়ে সুনামধন্য অনলাইন ওয়েবসাইট <a href="https://cutpricebd.com/bn/category/44/leather-jacket-winter-collections" class="text-green-800 underline">Cutpricebd.com</a>।
                </span></li>
                <li class="text-xl overflow-hidden mb-1"><img class="check_image inline-block mr-2 float-left" src="{{asset('landing/2705.svg')}}" alt="check"> <span class="float-left list_text">খুবই উন্নত মানের আমাদের  স্টাইলিশ জ্যাকেট গুলোতে ব্যবহার করা হয়েছে উন্নত মানের জিপার যা আপনার জ্যাকেট কি দীর্ঘমেয়াদি ভালো রাখতে সাহায্য করে।</span></li>
            </ul>
